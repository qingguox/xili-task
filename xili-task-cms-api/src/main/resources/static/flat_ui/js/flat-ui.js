...
!function (e, t, r) {
    ...
    }, window.getComputedStyle = Window.prototype.getComputedStyle = function (e) {
        return new r(e)
    })
    ...
    function a(e) {
        ...
        switch (e.font = {
            ...
            size: l(e.width, e.height, e.theme.size ? e.theme.size : 12),
        ...
        var r = new F({width: e.width, height: e.height}), n = r.Shape,
    ...
    function l(e, t, r) {
        ...
        var n = Math.max(t, e), i = Math.min(t, e), o = 1 / 12, a = Math.min(.75 * i, .75 * n * o);
    ...
    function d(e, t) {
        ...
        return r.height || r.width ? (e.removeAttribute("data-holder-invisible"), r) : (c(e, {"data-holder-invisible": !0}), void t.call(this, e))
    }
    ...
    function b(e) {
        for (var t = [], r = 0, n = e.length - 1; n >= 0; n--) r = e[n].charCodeAt(), t.unshift(r > 128 ? ["&#", r, ";"].join("") : e[n]);
        return t.join("")
    }
    ...
    var C = "http://www.w3.org/2000/svg", E = t.document, k = {
        addTheme: function (e, t) {
            ...
            for (c = 0; c < h.length; c++) {
                var O = h[c], F = {};
                try {
                    F.data = O.getAttribute("data"), F.dataSrc = O.getAttribute("data-src")
                } catch (z) {
                }
                var M = null != F.data && 0 === F.data.indexOf(a.domain),
                    D = null != F.dataSrc && 0 === F.dataSrc.indexOf(a.domain);
                M ? r(a, o, F.data, O) : D && r(a, o, F.dataSrc, O)
            }
            for (c = 0; c < l.length; c++) {
                ...
                B ? 0 === j.src.indexOf(a.domain) ? r(a, o, j.src, R) : P && (N ? r(a, o, j.dataSrc, R) : w({
                    src: j.src,
                    options: a,
                    renderSettings: o,
                    dataSrc: j.dataSrc,
                    ...
                    e || r(t.options, t.renderSettings, t.dataSrc, t.image)
                })) : P && r(a, o, j.dataSrc, R)
            }
            return this
    ...
    var A = {
        ...
        return function (r) {
            ...
            t.font = i.properties.font.weight + " " + A.dpr(i.properties.font.size) + "px " + i.properties.font.family + ", monospace", t.fillStyle = i.properties.fill;
    ...
    for (var z in A.flags) A.flags.hasOwnProperty(z) && (A.flags[z].match = function (e) {
