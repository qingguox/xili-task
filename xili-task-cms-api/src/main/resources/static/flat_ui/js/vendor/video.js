...
(function () {
    ...
    t.m = function (a, c) {
        ...
        c = t.qc(c);
        d.Y && d.Y.call(a, c);
        if (e && !c.Jb() && c.bubbles !== l) t.m(e, c); else if (!e && !c.defaultPrevented && (d = t.getData(c.target), c.target[c.type])) {
            d.disabled = f;
    ...
    s.vc = function () {
        var a, c, d, e;
        a = this;
        if (c = this.options().children) if (t.h.isArray(c)) for (var g = 0; g < c.length; g++) d = c[g], "string" == typeof d ? (e = d, d = {}) : e = d.name, a[e] = a.R(e, d); else t.h.Z(c, function (c, d) {
            d !== l && (a[c] = a.R(c, d))
        })
    };
    s.T = r("");
    ...
    function F(a, c, d, e) {
        if (d !== b) return a.b.style[c] = -1 !== ("" + d).indexOf("%") || -1 !== ("" + d).indexOf("px") ? d : "auto" === d ? "" : d + "px", e || a.m("resize"), a;
        if (!a.b) return 0;
        d = a.b.style[c];
        e = d.indexOf("px");
    ...
    s.e = function (a, c) {
        ...
        c.innerHTML || (this.v = t.e("div", {className: "vjs-control-content"}), this.yb = t.e("span", {
    ...
    s.ea = function (a) {
        if (37 == a.which || 40 == a.which) a.preventDefault(), this.Lc(); else if (38 == a.which || 39 == a.which) a.preventDefault(), this.Mc()
    };
    s.Ya = function () {
        t.p(document, "keyup", t.bind(this, this.ea))
    };
    ...
    t.I.prototype.e = function (a, c) {
        return t.t.prototype.e.call(this, "li", t.h.A({className: "vjs-menu-item", innerHTML: this.l.label}, c))
    };
    ...
    function P(a, c, d) {
        ...
        a.fb = c;
        a.ma = l;
        var e = t.h.A({source: d, parentEl: a.b}, a.l[c.toLowerCase()]);
    ...
    s.volume = function (a) {
        if (a !== b) return a = Math.max(0, Math.min(1, parseFloat(a))), this.G.volume = a, S(this, "setVolume", a), t.Zd(a), this;
    ...
    s.requestFullscreen = function () {
        ...
        })), this.b[a.requestFullscreen]()) : this.k.Ea() ? S(this, "enterFullScreen") : (this.pc(), this.m("fullscreenchange"));
        return this
    };
    s.exitFullscreen = function () {
        var a = t.Pa.Fb;
        this.isFullscreen(l);
        if (a) document[a.exitFullscreen](); else this.k.Ea() ? S(this, "exitFullScreen") : (this.Db(), this.m("fullscreenchange"));
        return this
    };
    s.pc = function () {
        this.Cd = f;
        ...
        for (var c = 0, d = this.l.techOrder; c < d.length; c++) {
            ...
            if (g) {
                if (g.isSupported()) for (var h = 0, j = a; h < j.length; h++) {
                    var n = j[h];
                    if (g.canPlaySource(n)) return {source: n, k: e}
                }
    ...
    s.src = function (a) {
        ...
        t.h.isArray(a) ? T(this, a) : "string" === typeof a ? this.src({src: a}) : a instanceof Object && (a.type && !window.videojs[this.fb].canPlaySource(a) ? T(this, [a]) : (this.G.src = a.src, this.nc = a.type || "", this.J(function () {
            S(this, "src", a.src);
    ...
    t.pb.prototype.l = {children: {seekBar: {}}};
    ...
    t.sb.prototype.l = {children: {volumeBar: {}}};
    ...
    s.l = {children: {volumeLevel: {}, volumeHandle: {}}, barName: "volumeLevel", handleName: "volumeHandle"};
    s.Cc = "volumechange";
    s.e = function () {
    ...
    t.sa.prototype.xa = function () {
        var a = new t.ia(this.c, {lc: "div"}), c = new t.rb(this.c, t.h.A({vertical: f}, this.l.we));
        a.R(c);
        return a
    };
    ...
    s.e = function () {
        ...
        this.yc = t.e("div", {className: "vjs-playback-rate-value", innerHTML: 1});
        a.appendChild(this.yc);
        return a
    };
    s.xa = function () {
        var a = new t.ia(this.j()), c = this.j().options().playbackRates;
        if (c) for (var d = c.length - 1; 0 <= d; d--) a.R(new t.ob(this.j(), {rate: c[d] + "x"}));
        return a
    };
    s.pa = function () {
    ...
    t.u = t.a.extend({
        i: function (a, c, d) {
            ...
            this.o.timeupdateEvents || (this.Lb = f, this.j().d("play", t.bind(this, this.Pc)), this.j().d("pause", t.bind(this, this.eb)), this.X("timeupdate", function () {
    ...
    s.e = function () {
        ...
        if (!c || this.o.movingMediaElementInDOM === l) c ? (d = c.cloneNode(l), t.g.Cb(c), c = d, a.P = k) : (c = t.e("video"), t.Ic(c, t.h.A(a.ge || {}, {
            id: a.id() + "_html5_api",
            "class": "vjs-tech"
    ...
    t.f = t.u.extend({
        i: function (a, c, d) {
            ...
            var e = c.source;
            d = c.parentEl;
            var g = this.b = t.e("div", {id: a.id() + "_temp_flash"}), h = a.id() + "_flash_api", j = a.l, j = t.h.A({
                    ...
                    loop: j.loop,
                    muted: j.muted
                }, c.flashVars), n = t.h.A({wmode: "opaque", bgcolor: "#000000"}, c.params),
                h = t.h.A({id: h, name: h, "class": "vjs-tech"}, c.attributes);
            e && (e.type && t.f.Ed(e.type) ?
                (e = t.f.Nc(e.src), j.rtmpConnection = encodeURIComponent(e.xb), j.rtmpStream = encodeURIComponent(e.Rb)) : j.src = encodeURIComponent(t.sc(e.src)));
            t.Hb(g, d);
    ...
    t.f.Oc = {"rtmp/mp4": "MP4", "rtmp/flv": "FLV"};
    ...
    function Y(a, c, d) {
        for (var e = a.Fa, g = 0, h = e.length, j, n; g < h; g++) j = e[g], j.id() === c ? (j.show(), n = j) : d && (j.K() == d && 0 < j.mode()) && j.disable();
    ...
    function na(a) {
        0 === a.oa && a.load();
        0 === a.na && (a.c.d("timeupdate", t.bind(a, a.update, a.U)), a.c.d("ended", t.bind(a, a.reset, a.U)), ("captions" === a.H || "subtitles" === a.H) && a.c.la("textTrackDisplay").R(a))
    }
        ...
        if (0 < this.ca.length) {
            ...
            if (this.Pb === b || a < this.Pb || this.Xa <= a) {
                ...
                for (; ;) {
                    ...
                    } else g ? (h.splice(0, 0, q), n === b && (n = w), j = w) : (h.push(q), j === b && (j = w), n = w), d = Math.min(d,
                        q.ya), e = Math.max(e, q.startTime), q.Oa = f;
    ...
    t.nb.prototype.update = function () {
        for (var a = this.c.textTracks(), c = 0, d = a.length, e, g = f; c < d; c++) e = a[c], e.K() == this.fa.K() && 2 == e.mode() && (g = l);
        this.selected(g)
    };
    t.V = t.L.extend({
        i: function (a, c) {
    ...
    t.V.prototype.wa = function () {
        ...
        for (var d = 0; d < this.c.textTracks().length; d++) c = this.c.textTracks()[d], c.K() === this.H && a.push(new t.aa(this.c, {track: c}));
        return a
    };
    t.Ha = t.V.extend({
        i: function (a, c, d) {
    ...
    s.wa = function () {
        for (var a = [], c, d = 0; d < this.c.textTracks().length; d++) c = this.c.textTracks()[d], c.K() === this.H && a.push(new t.aa(this.c, {track: c}));
        return a
    };
    s.xa = function () {
        for (var a = this.c.textTracks(), c = 0, d = a.length, e, g, h = this.O = []; c < d; c++) if (e = a[c], e.K() == this.H) if (0 === e.readyState()) e.load(), e.d("loaded", t.bind(this, this.xa)); else {
            g = e;
            break
        }
        a = this.Ba;
    ...
    t.jc = function () {
        ...
        if (d && 0 < d.length) for (var e = 0, g = d.length; e < g; e++) if ((c = d[e]) && c.getAttribute) c.player === b && (a = c.getAttribute("data-setup"), a !== k && (a = t.JSON.parse(a || "{}"), videojs(c, a))); else {
            t.vb();
            break
        } else t.Tc || t.vb()
    };
